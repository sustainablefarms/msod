...
artmodel <- artificial_runjags(nspecies = 60, nsites = 2000, nvisitspersite = 2, modeltype = "jsodm_lv", nlv = 4)
...
test_that("Expected Number of Detected Species", {
  ...
  Enumspec <- predsumspecies(fit_runjags, UseFittedlv.v = TRUE, type = "marginal", cl = cl)
  Enumspec_art <- predsumspecies(artmodel, UseFittedlv.v = TRUE, type = "marginal", cl = cl)
